...
export const firearmsLicenceSchema = z
  .object({
    firearmsNumber: z
      .string({
...
export const kiwiAccessCardSchema = z
  .object({
...
export const communityServiceCardSchema = z
  .object({
...
export const birthCertificateSchema = z
  .object({
...
export const currentStudentCardSchema = z
  .object({
